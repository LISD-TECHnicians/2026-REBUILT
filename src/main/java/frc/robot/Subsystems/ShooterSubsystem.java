...
public class ShooterSubsystem extends SubsystemBase{
    ...
    public ShooterSubsystem() {
        ...
        m_shooterMotor1 = new TalonFX(ShooterConstants.kShooterMotor1ID);
        m_shooterMotor2 = new TalonFX(ShooterConstants.kShooterMotor2ID);
        m_shooterMotor3 = new TalonFX(ShooterConstants.kShooterMotor3ID);
        m_shooterMotors = List.of(m_shooterMotor1, m_shooterMotor2, m_shooterMotor3);
    ...
    public void configureMotors() {
        m_shooterMotorConfig = new TalonFXConfiguration()
            ...
            m_shooterMotor1.getConfigurator().apply(m_shooterMotorConfig);
            m_shooterMotor2.getConfigurator().apply(m_shooterMotorConfig);
            m_shooterMotor3.getConfigurator().apply(m_shooterMotorConfig);
    ...
    public Distance calculateServoLength(Angle theta)
    {
        ...
        // TODO: Test both possible solutions for best fit
    ...
    public Angle getCalculatedPitch() {
        ...
        /* TODO: Consider if getting the tangential here makes sense as it would not be at speed yet.
        ...
        for (final TalonFX shooterMotor : m_shooterMotors) {
            shooterMotor.setControl(
                m_shooterVoltageRequest
                    .withOutput(Units.Volts.of(setSpeed * CTREConstants.kBatterySupplyVolts))
            );
        }
     }
    ...
    public double getTangentialVelocity() {
        double wheelRPM = m_shooterMotor1.getVelocity().getValueAsDouble() * 60.0; // Convert rot/s to RPM
